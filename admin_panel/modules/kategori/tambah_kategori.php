<?php
require_once '../../../db_connect.php'; // Sesuaikan path jika struktur folder berbeda
...
// Ambil data form jika ada error validasi sebelumnya
$form_data = $_SESSION['form_data_kategori'] ?? [];
unset($_SESSION['form_data_kategori']);
$error_message = $_SESSION['kategori_error_message'] ?? '';
unset($_SESSION['kategori_error_message']);
...
<head>
    ...
    <title>Tambah Kategori Baru - Bloomarie Admin</title>
    ...
    <div class="main-content">
        ...
        <div class="data-table-card">
            <div class="card-header">
                <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Formulir Kategori</h5>
            </div>
            <div class="card-body admin-form">
                ...
                <form action="proses_kategori.php" method="POST">
                    ...
                    <hr>
                    <button type="submit" class="btn btn-primary-admin"><i class="fas fa-save me-2"></i> Simpan Kategori</button>
